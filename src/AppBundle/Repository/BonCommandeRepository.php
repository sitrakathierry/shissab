...
class BonCommandeRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    )
    {
        ...
        $query = "  select b.id, date_format(b.date, '%d/%m/%Y') as date, b.total as montant_total, LPAD(b.id, 6, '0') as recu, IF(c.statut = 1,cm.nom_societe,cp.nom) as client, b.statut, b.remise, b.montant_remise, b.tva, b.montant_tva, b.ht
                    from bon_commande b
