...
$(document).ready(function(){
    ...
    function instance_list_grid() {
        var colNames = ['N° Facture','Type','Designation','Date de création','Date facture','Client','Total'];
        var colModel = [{
                name    : 'num_fact',
                index   : 'num_fact',
                align   : 'left',
                ...
                index   : 'type_designation',
                align   : 'left',
                editable: false,
                sortable: false,
                classes : 'js-type_designation',
	...
	function load_list(){
		var url = Routing.generate('recette_general_list')
		var data = {
