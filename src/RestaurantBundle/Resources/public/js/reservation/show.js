$(document).ready(function(){
	...
	$(document).on('click','#btn-payer',function(event) {
		...
		var url = Routing.generate('restaurant_reservation_payer', { id : id });
    ...
    function calculTotal() {
        ...
        $('table#table-reservation-add > tbody  > tr').each(function(index, tr) { 
           ...
           $('#montant_a_payer').val(montant_total);
	...
	$(document).on('click', '#print', function(event) {
		...
		var url = Routing.generate('restaurant_reservation_ticket');
    ...
    $(document).on('click','#btn-delete',function(event) {
        ...
        var url = Routing.generate('restaurant_reservation_delete', { id : $('#id').val() });
        ...
        swal({
          ...
          function () {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(res) {
                    show_success('Succès', 'Suppression éffectué', Routing.generate('restaurant_reservation_index'));
                }
            });
        });
    });
