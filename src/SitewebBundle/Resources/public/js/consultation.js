...
$(document).ready(function(){
	...
	function instance_grid() {
        ...
        },
        {
            ...
            align: 'center',
            formatter: function(v){ 
                return '<button class="btn btn-xs btn-outline btn-primary edit_siteweb " data-type="0"><i class="fa fa-pencil-square-o "></i>&nbsp;Afficher</button> &nbsp;'; 
            }
        }];
	...
	$(document).on('click', '.edit_siteweb', function(){
        ...
        location.href = Routing.generate('siteweb_show', { id : id })
