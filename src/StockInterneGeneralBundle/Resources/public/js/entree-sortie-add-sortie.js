$(document).ready(function(){
    ...
    $(document).on('click', '#btn-save', function(event) {
        ...
        if(enregistre)
    	{
            ...
            var url = Routing.generate('stock_interne_general_entree_sortie_save_sortie');
        ...
        else
        {
            if(negatif)
            {
                swal({
                    type: 'error',
                    title:  "Mouvement Négatif",
                    text: "Vérifier le Mouvement",
            ...
            else
            {
                swal({
                    type: 'warning',
                    title:  "Mouvement Vide ou Invalide",
                    text: "Remplissez ou corriger le Mouvement",
                    // footer: '<a href="">Misy olana be</a>'
                })
            }
