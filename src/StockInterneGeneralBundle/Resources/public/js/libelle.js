...
$(document).ready(function(){
	...
	function load_list(){
		var url = Routing.generate('stock_interne_general_libelle_list')
		var data = {
		};
	...
	$(document).on('click','#btn-save',function(event) {
		...
		var url = Routing.generate('stock_interne_general_libelle_save');
		$.ajax({
			url: url,
			data: data,
			type: 'POST',
    ...
    $(document).on('click', '.cl_edit_libelle', function(){
        ...
        if (action === 2) {
            ...
            swal({
                ...
                var url = Routing.generate('stock_interne_general_libelle_delete',{
                    id : id
                });
    ...
    function show_editeur_libelle(id)
    {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: Routing.generate('stock_interne_general_libelle_editor'),
            dataType: 'html',
    ...
    function edit_libelle(act, data)
    {
        $.ajax({
            data: data,
            type: 'POST',
            url: Routing.generate('stock_interne_general_libelle_save'),
            dataType: 'html',
            success: function(data) {
